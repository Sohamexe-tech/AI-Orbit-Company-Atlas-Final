...
const COMPANY_SEEDS = [
  { slug: "openai", name: "OpenAI", tagline: "Research and products pushing the frontier of artificial intelligence.", description: "OpenAI builds general-purpose AI systems and developer products, with a focus on useful, increasingly capable models and the infrastructure around them.", logoUrl: "OA", websiteUrl: "https://openai.com", linkedinUrl: "https://www.linkedin.com/company/openai/", industry: "Foundation Models", location: "San Francisco, CA", foundedYear: 2015, companySize: "1,000+", fundingStage: "Late stage", featured: true, verified: true },
  { slug: "anthropic", name: "Anthropic", tagline: "AI safety and research company building reliable frontier models.", description: "Anthropic develops frontier AI systems with an emphasis on reliability, interpretability and responsible deployment for individuals and organizations.", logoUrl: "AN", websiteUrl: "https://www.anthropic.com", linkedinUrl: "https://www.linkedin.com/company/anthropicresearch/", industry: "Foundation Models", location: "San Francisco, CA", foundedYear: 2021, companySize: "1,000+", fundingStage: "Late stage", featured: true, verified: true },
  { slug: "hugging-face", name: "Hugging Face", tagline: "The open platform for models, datasets and AI collaboration.", description: "Hugging Face provides open-source tooling, model and dataset hosting, inference services and a community layer for machine learning developers and researchers.", logoUrl: "HF", websiteUrl: "https://huggingface.co", githubUrl: "https://github.com/huggingface", industry: "AI Infrastructure", location: "New York, NY", foundedYear: 2016, companySize: "500–1,000", fundingStage: "Late stage", featured: true, verified: true },
  { slug: "scale-ai", name: "Scale AI", tagline: "Data and evaluation infrastructure for AI applications.", description: "Scale AI develops data annotation, evaluation and AI application infrastructure used to build and measure machine learning systems.", logoUrl: "SC", websiteUrl: "https://scale.com", industry: "AI Infrastructure", location: "San Francisco, CA", foundedYear: 2016, companySize: "1,000+", fundingStage: "Late stage", featured: true, verified: true },
  { slug: "perplexity", name: "Perplexity", tagline: "An answer engine for research and discovery.", description: "Perplexity combines conversational search with cited web research to help people investigate questions and topics through an AI-first interface.", logoUrl: "PX", websiteUrl: "https://www.perplexity.ai", industry: "AI Search", location: "San Francisco, CA", foundedYear: 2022, companySize: "200–500", fundingStage: "Growth", featured: true, verified: true },
  { slug: "cursor", name: "Cursor", tagline: "An AI-first code editor for building software.", description: "Cursor is an AI-powered development environment designed around codebase context, editing workflows and agentic software development.", logoUrl: "CU", websiteUrl: "https://www.cursor.com", industry: "Developer AI", location: "San Francisco, CA", foundedYear: 2022, companySize: "100–200", fundingStage: "Growth", featured: false, verified: true },
  { slug: "runway", name: "Runway", tagline: "Generative AI tools for creative production and video.", description: "Runway builds generative media systems and creative workflows for producing and editing images, video and other visual content.", logoUrl: "RW", websiteUrl: "https://runwayml.com", industry: "Generative Media", location: "New York, NY", foundedYear: 2018, companySize: "200–500", fundingStage: "Growth", featured: false, verified: true },
  { slug: "mistral-ai", name: "Mistral AI", tagline: "Efficient open and commercial models from Europe.", description: "Mistral AI develops language models and developer products, including open-weight systems and APIs designed for flexible deployment.", logoUrl: "MI", websiteUrl: "https://mistral.ai", industry: "Foundation Models", location: "Paris, France", foundedYear: 2023, companySize: "200–500", fundingStage: "Growth", featured: true, verified: true },
  { slug: "replicate", name: "Replicate", tagline: "Run machine learning models through a simple developer API.", description: "Replicate provides infrastructure for running and integrating machine learning models, helping developers turn model experiments into products.", logoUrl: "RE", websiteUrl: "https://replicate.com", githubUrl: "https://github.com/replicate", industry: "AI Infrastructure", location: "San Francisco, CA", foundedYear: 2019, companySize: "50–100", fundingStage: "Growth", featured: false, verified: true },
  { slug: "elevenlabs", name: "ElevenLabs", tagline: "AI voice technology for speech, audio and agents.", description: "ElevenLabs develops voice generation, speech synthesis and conversational audio technology for creators, developers and businesses.", logoUrl: "EL", websiteUrl: "https://elevenlabs.io", industry: "Voice AI", location: "New York, NY", foundedYear: 2022, companySize: "200–500", fundingStage: "Growth", featured: false, verified: true },
  { slug: "cognition", name: "Cognition", tagline: "Building AI agents for software engineering workflows.", description: "Cognition develops agentic software engineering systems intended to help developers plan, implement and iterate on software projects.", logoUrl: "CO", websiteUrl: "https://cognition.ai", industry: "Developer AI", location: "San Francisco, CA", foundedYear: 2023, companySize: "100–200", fundingStage: "Growth", featured: false, verified: true },
  { slug: "groq", name: "Groq", tagline: "High-speed inference infrastructure for AI workloads.", description: "Groq builds specialized compute and software infrastructure focused on fast inference for modern AI models and applications.", logoUrl: "GQ", websiteUrl: "https://groq.com", industry: "AI Infrastructure", location: "Mountain View, CA", foundedYear: 2016, companySize: "200–500", fundingStage: "Late stage", featured: false, verified: true },
  { slug: "nuro", name: "Nuro", tagline: "Autonomous technology for everyday delivery and mobility.", description: "Nuro develops autonomous driving technology and delivery vehicles intended to move goods safely without a human driver.", logoUrl: "NU", websiteUrl: "https://www.nuro.ai", industry: "Robotics & Autonomy", location: "Mountain View, CA", foundedYear: 2016, companySize: "500–1,000", fundingStage: "Late stage", featured: false, verified: true },
  { slug: "figure-ai", name: "Figure AI", tagline: "General-purpose humanoid robots for useful work.", description: "Figure AI develops humanoid robots and AI systems aimed at enabling general-purpose robots to operate in real-world environments.", logoUrl: "FI", websiteUrl: "https://www.figure.ai", industry: "Robotics & Autonomy", location: "Sunnyvale, CA", foundedYear: 2022, companySize: "200–500", fundingStage: "Growth", featured: true, verified: true },
  { slug: "weights-biases", name: "Weights & Biases", tagline: "Developer tools for building and evaluating machine learning systems.", description: "Weights & Biases provides experiment tracking, evaluation, model management and collaboration tooling for machine learning teams.", logoUrl: "WB", websiteUrl: "https://wandb.ai", industry: "ML Developer Tools", location: "San Francisco, CA", foundedYear: 2017, companySize: "500–1,000", fundingStage: "Late stage", featured: false, verified: true },
  { slug: "pinecone", name: "Pinecone", tagline: "Vector database infrastructure for AI applications.", description: "Pinecone provides managed vector database infrastructure for semantic search, retrieval-augmented generation and AI applications.", logoUrl: "PI", websiteUrl: "https://www.pinecone.io", industry: "AI Infrastructure", location: "New York, NY", foundedYear: 2019, companySize: "200–500", fundingStage: "Growth", featured: false, verified: true },
  { slug: "adept", name: "Adept", tagline: "AI systems designed to help people use software through natural language.", description: "Adept researches AI agents that can understand software interfaces and carry out useful actions across digital workflows.", logoUrl: "AD", websiteUrl: "https://www.adept.ai", industry: "AI Agents", location: "San Francisco, CA", foundedYear: 2022, companySize: "50–100", fundingStage: "Growth", featured: false, verified: true },
  { slug: "character-ai", name: "Character.AI", tagline: "Conversational AI experiences built around expressive characters.", description: "Character.AI develops consumer conversational AI experiences where users can interact with and create characters for entertainment, learning and exploration.", logoUrl: "CA", websiteUrl: "https://character.ai", industry: "Consumer AI", location: "Menlo Park, CA", foundedYear: 2021, companySize: "200–500", fundingStage: "Growth", featured: false, verified: true },
];
...
async function main(): Promise<void> {
  ...
  // Companies module seed ----------------------------------------------------------
  await prisma.company.deleteMany();
  await prisma.company.createMany({ data: COMPANY_SEEDS });
